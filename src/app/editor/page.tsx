...
export default function EditorPage() {
    ...
    return (
        <main className="min-h-screen bg-warm-bg text-text-primary pb-20">
            ...
            >
                {sections.map((section) => (
                    <section
                        key={section.id}
                        className={`relative ${isEditMode ? "outline-2 outline-dashed outline-warm-border rounded-xl" : ""
                            }`}
                    >
                        {isEditMode && (
                            <SectionToolbar
                ...
                {isEditMode && (
                    <button
                        ...
                        className="w-full py-3 border-2 border-dashed border-warm-border rounded-xl text-xs font-medium text-text-muted hover:border-crimson/30 hover:text-crimson hover:bg-rose-tint/50 transition-all"
                    >
                        + Add Section
                    </button>
                )}
